        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <div className="flex space-x-4 pt-4">
              ...
              <a href="https://www.instagram.com/pbadvisory/" className="text-white hover:text-gray-300 transition">
                <Instagram size={20} />
              </a>
              <a href="https://www.linkedin.com/company/prime-balance-advisory" className="text-white hover:text-gray-300 transition">
                <Linkedin size={20} />
              </a>
            </div>
          </div>
